...
class CustomerResourceIT {
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getWeb()).isEqualTo(DEFAULT_WEB);
    ...
    void putExistingCustomer() throws Exception {
        ...
        assertThat(testCustomer.getWeb()).isEqualTo(UPDATED_WEB);
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).companyName(UPDATED_COMPANY_NAME).telephone(UPDATED_TELEPHONE).email(UPDATED_EMAIL);
